        ...
        public static _Trans Language = new _Trans
        {
            ...
            Main = new TMain
            {
                Commands = new List<string>
                {
                    ...
                    "[ mc/skin (Gracz) ]( Skórka gracza )",
                    "[ mc/names (Gracz) ]( Historia nazw kont MC )",
                    "[ mc/status ]( Mojang status )",
                    "[ mc/get (Tekst) ]( Zdobądź osiągnięcie )",
                    "[ mc/minime (Gracz) ]( Zmniejsz skórkę gracza )",
                    "[ mc/playing ]( Ludzie grający w Minecrafta )",
                    "[ mc/user ]( Twoje konto Minecraft, skórka i statystyki )",
                    "[ mc/rcon ]( Funkcja zdalnej konsoli serwera Minecraft )",
                    "[ mc/hypixel (Gracz) ]( Statystyki gracza Hypixel )",
