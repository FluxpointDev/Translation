        ...
        public static _Trans Language = new _Trans
        {
            ...
            Main = new TMain
            {
                Commands = new List<string>
                {
                    ...
                    "[ mc/skin (Pemain) ]( Kulit pemain )",
                    "[ mc/names (Pemain) ]( Sejarah nama akun MC )",
                    "[ mc/status ]( Mojang status )",
                    "[ mc/get (Teks) ]( Dapatkan prestasi )",
                    "[ mc/minime (Pemain) ]( Minimalkan kulit pemain )",
                    "[ mc/playing ]( Orang-orang bermain Minecraft )",
                    "[ mc/user ]( Akun Minecraft Anda, kulit dan statistiknya )",
                    "[ mc/rcon ]( Fitur konsol remote server Minecraft )",
                    "[ mc/hypixel (Pemain) ]( Statistik pemain hypixel )",
